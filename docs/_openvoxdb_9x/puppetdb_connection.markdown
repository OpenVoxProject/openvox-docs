...
Unlike the server-side [`facts-blocklist`](./configure.html#facts-blocklist) setting, this filtering happens in the
termini before submission and can remove single keys from structured facts.
