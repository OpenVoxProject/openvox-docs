...
> ```
>
> OpenVox 9 is removing this fallback ([openvox#334](https://github.com/OpenVoxProject/openvox/issues/334)). Once it is gone, the hyphenated form is rejected as an unknown argument, so update any scripts that still use it.
>
