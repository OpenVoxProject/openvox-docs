...
[catalogs]: ./subsystem_catalog_compilation.md
[catalog endpoint]: ./http_api/http_catalog.md
[file metadata]: ./http_api/http_file_metadata.md
[`file_content`]: ./http_api/http_file_content.md
[`static_file_content`]: https://puppet.com/docs/puppetserver/latest/puppet-api/v3/static_file_content.html
[resource_declaration]: ./lang_resources.md
[file resources]: ./types/file.md
[puppet catalog]: ./man/catalog.md
[environment]: ./environments.md
[facts]: ./lang_facts_and_builtin_vars.md
[exported resources]: ./lang_exported.md
[main manifest]: ./dirs_manifest.md
[modules]: ./modules_fundamentals.md
[resources]: ./lang_resources.md
[variables]: ./lang_variables.md
[classes]: ./lang_classes.md
[modulepath]: ./dirs_modulepath.md
[`puppet.conf`]: ./config_file_main.md
[`environment.conf`]: ./config_file_environment.md

[Puppet Server]: https://puppet.com/docs/puppetserver/latest/
[`puppetserver.conf`]: https://puppet.com/docs/puppetserver/latest/config_file_puppetserver.html
...
[`code_content`]: https://puppet.com/docs/puppetserver/latest/
