...
Hierarchy levels are configured in [hiera.yaml](./hiera_config_yaml_5.md). When calling a backend function, Hiera passes a modified version of that configuration as a hash.
