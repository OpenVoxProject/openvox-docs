...
Functions are plugins you can call during catalog compilation. A call to any function is an expression that resolves to a value. For more information on how to call functions, see [the language reference page about function calls.](./lang_functions.md) 

Many of these function descriptions include auto-detected _signatures,_ which are short reminders of the function's allowed arguments. These signatures aren't identical to the syntax you use to call the function; instead, they resemble a parameter list from a Puppet [class](./lang_classes.md), [defined resource type](./lang_defined_types.md), [function](./lang_write_functions_in_puppet.md), or [lambda](./lang_lambdas.md). The syntax of a signature is:

```
<FUNCTION NAME>(<DATA TYPE> <ARGUMENT NAME>, ...)
```

The `<DATA TYPE>` is a [Puppet data type value](./lang_data_type.md), like `String` or `Optional[Array[String]]`. The `<ARGUMENT NAME>` is a descriptive name chosen by the function's author to indicate what the argument is used for.
...
* Arguments that start with an ampersand (like `&$block`) aren't normal arguments; they represent a code block, provided with [Puppet's lambda syntax.](./lang_lambdas.md)
...
Runs a [lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md)
...
[iteration](https://puppet.com/docs/puppet/latest/lang_iteration.md)
documentation.
...
[data type](https://puppet.com/docs/puppet/latest/lang_data.md), or
otherwise either raises an error or executes an optional two-parameter
[lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md).
...
[documentation](https://puppet.com/docs/puppet/latest/lang_data.md).
...
**Note**: Use this function selectively. It's generally better to write resources in
 [Puppet](https://puppet.com/docs/puppet/latest/lang_resources.md), as
...
[hash](https://puppet.com/docs/puppet/latest/lang_data_hash.md) that contains parameters to
pass to the template.

- See the [template](https://puppet.com/docs/puppet/latest/lang_template.md)
documentation for general template usage information.
- See the [EPP syntax](https://puppet.com/docs/puppet/latest/lang_template_epp.md)
...
Applies a [lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md)
...
[hierarchy level](https://puppet.com/docs/hiera/latest/hierarchy.md) to insert at the
...
[lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md) that
takes one parameter.
...
See
[the 'Using the lookup function' documentation](https://puppet.com/docs/puppet/latest/hiera_automatic.md) for how to perform lookup of data.
Also see
[the 'Using the deprecated hiera functions' documentation](https://puppet.com/docs/puppet/latest/hiera_automatic.md)
...
When called with a  [lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md)
...
[the templating docs](https://puppet.com/docs/puppet/latest/lang_template.md) for
...
Calls a [lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md)
...
[data type](https://puppet.com/docs/puppet/latest/lang_data_type.md)
...
[lambda](https://puppet.com/docs/puppet/latest/lang_lambdas.md) for each
element.
...
See the documentation for the [`Kernel::sprintf` function](https://ruby-doc.org/core/Kernel.md)
in Ruby for details.

To use [named format](https://idiosyncratic-ruby.com/49-what-the-format.md) arguments, provide a
