...
{% include alert.html type="info" content="It's worth knowing that while linters often indicate problems in the code, they're not always guaranteed to catch all syntax errors. Make sure to read about the `puppet_syntax` task." %}
