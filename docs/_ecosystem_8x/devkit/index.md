...
{% include alert.html type="tip" content="If you're already familiar with maintaining Puppet content and testing and you just want to know how to migrate away from the PDK, you can [skip directly to that guide](migration.html)." %}
