---
layout: default
title: " What Is OpenVox?"
---

[OpenVox](https://github.com/openvoxproject) is a **community-driven, open-source configuration management platform** —
a continuation of Puppet's open-source heritage, maintained by the [Vox Pupuli](https://voxpupuli.org/) community.
If you've ever used Puppet, you already know OpenVox.
It's the same powerful declarative language, the same agent/server architecture,
and the same ecosystem of thousands of modules on the [Puppet Forge](https://forge.puppet.com/) but it's **100% open source**, forever, with no corporate strings attached.
