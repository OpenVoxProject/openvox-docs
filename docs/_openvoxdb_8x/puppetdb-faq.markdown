...
Because OpenVoxDB uses the certificate authority (CA) of your Puppet
...
## My Puppet Server is running slower since I enabled OpenVoxDB. How can I profile it?

Puppet 3.x introduced a new profiling capability that we leveraged in the
openvoxdb-termini client code. By simply adding `profile=true` to your
`puppet.conf`, you can enable detailed profiling of all aspects of Puppet,
including openvoxdb-termini. For this to work, you must enable debugging on your
