...
layout: default
canonical: "/openvoxdb/latest/api/wire_format/catalog_format_v9.html"
---
...
String. The certname of the Puppet Server that sent the catalog to OpenVoxDB. This field may be `null`.
