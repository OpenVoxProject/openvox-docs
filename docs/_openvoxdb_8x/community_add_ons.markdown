...
layout: default
canonical: "/openvoxdb/latest/community_add_ons.html"
---
# Community add-ons
...
## [Zack Smith --- Puppet face for querying OpenVoxDB exports][exports]
...
[A set of command-line scripts for querying OpenVoxDB.][cms-puppetdb-tools] This was originally written for use in a specific Puppet environment, but includes a few scripts that are more generally useful. This includes:
