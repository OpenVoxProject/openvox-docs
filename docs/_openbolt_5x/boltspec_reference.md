...
how to use these functions, see [Testing plans](testing_plans.html).
...
The `expect_out_message` function mocks the [`out::message` function](plan_functions.html#outmessage).
...
The `expect_out_verbose` function mocks the [`out::verbose` function](plan_functions.html#outverbose). It does not accept parameters.
...
function](plan_functions.html#apply). It does not accept parameters or
...
function](plan_functions.html#outmessage). It does not accept parameters.
...
function](plan_functions.html#outverbose). It does not accept parameters.
...
- For more information on using `BoltSpec`, see [Testing plans](testing_plans.html).
