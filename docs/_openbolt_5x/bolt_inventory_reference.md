...
Use an [inventory file](inventory_files.html) to store information about
...
precedence, see [Inventory files](inventory_files.html)
...
reference](bolt_transports_reference.html).
...
[Transport configuration reference](bolt_transports_reference.html).
