...
- [Changes coming in Bolt 3.0](developer_updates.html#changes-coming-in-bolt-30)
...
a Bolt project](projects.html#migrate-a-bolt-project).
...
1. Move any [transport configuration](bolt_transports_reference.html) to be under
...
1. Move any [transport configuration](bolt_transports_reference.html) to the
...
modulepath, see the [Modules overview](modules.html). For information on
installing your modules, see [Installing modules](bolt_installing_modules.html).
