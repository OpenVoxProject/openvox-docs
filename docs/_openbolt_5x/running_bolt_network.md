...
[Bolt plans](plans.html) can execute Puppet code from [apply
blocks](applying_manifest_blocks.html#applying-manifest-blocks-from-a-puppet-plan), including applying
