...
config](configuring_bolt.html) with the following values:
...
your [Bolt config](configuring_bolt.html).
...
Alternatively, the [PuppetDB inventory plugin](using_plugins.html) can be used to
