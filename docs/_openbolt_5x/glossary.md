...
Use the `apply` [Bolt plan function](writing_plans.html) to apply a block of Puppet code (also known as a manifest
block) to a target.
...
A controller is any device that you use to run Bolt. See [Installing Bolt](bolt_installing.html)
...
- [Background function](plan_functions.html#background)
- [Wait function](plan_functions.html#wait)
- [Future custom type](bolt_types_reference.html#future)
...
- [Inspecting plans](inspecting_plans.html)
...
- [Supported plug-ins](supported_plugins.html)
- [Using plug-ins](using_plugins.html)
- [Writing plug-ins](writing_plugins.html)
...
- [Common project files & directories](projects.html#common-files-and-directories-in-a-project)
...
- [Inspecting tasks](inspecting_tasks.html)
...
- [Specify a transport](running_bolt_commands.html#specify-a-transport)
- [Transport config options](bolt_transports_reference.html)
...
- [Type aliases](bolt_types_reference.html#type-aliases)
