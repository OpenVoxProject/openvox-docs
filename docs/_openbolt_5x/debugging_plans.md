...
| --- | --- |
| `trace` | [`log::trace`](plan_functions.html#logtrace) |
| `debug` | [`log::debug`](plan_functions.html#logdebug) |
| `info` | [`log::info`](plan_functions.html#loginfo) |
| `warn` | [`log::warn`](plan_functions.html#logwarn) |
| `error` | [`log::error`](plan_functions.html#logtrace) |
| `fatal` | [`log::fatal`](plan_functions.html#logfatal) |
...
result](bolt_types_reference.html#planresult), Bolt formats and prints the value
...
- Using the [`out::message` plan function](plan_functions.html#outmessage).
- Using the [`out::verbose` plan function](plan_functions.html#outverbose).
...
- Using the [`message` step](writing_yaml_plans.html#message-step).
- Using the [`verbose` step](writing_yaml_plans.html#verbose-step).
