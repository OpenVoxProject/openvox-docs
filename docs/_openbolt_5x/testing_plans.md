...
structure expected in a [configuration file](bolt_project_reference.html).
...
structure expected in an [inventory file](inventory_files.html).
...
object](bolt_types_reference.html#planresult), which you can examine and make
...
- See the [BoltSpec reference](boltspec_reference.html) for a full list of
  modifiers.
...
- For more information on the available mocks and stubs, see the [BoltSpec
  reference](boltspec_reference.html).
